  ...
  return (
    ...
    <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
      <div className="flexStart flex-1 flex-col">
        ...
        <p className="font-poppins dark:text-white text-nft-gray-1 font-semibold text-base mt-6">Get the latest Updates</p>
        <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2
      ...
      <FooterLinks heading='Support' items={['Help Center','Terms of service','Legal','Privcay Policy']}/>
      </div>
    </div>
